  ...
  return (
    ...
    <div className=" w-[80%] md:w-[75%]   ">
      ...
      <div className="grid grid-cols-1 gap-5 py-1 mt-3 lg:grid-cols-2">
        <div className="bg-[#96E2D6] flex justify-between md:items-center h-fit flex-col md:flex-row  px-[3%] md:px-5 rounded-2xl py-[2rem] md:h-[11rem]">
        ...
        <div className="bg-[#96E2D6] flex justify-between md:items-center flex-col md:flex-row  h-fit px-[3%] md:px-5 rounded-2xl py-[2rem] md:h-[11rem]">
          ...
          <div className="h-[4rem]  flex w-[4rem]"> <img src={drive} alt="" /></div>
            ...
            <div className="flex items-center justify-end md:justify-center">
            <button className="h-[2rem] flex  items-center  lg-px-7 px-4   lg:font-bold  lg:text-xl  rounded-md text-white hover:bg-[#00423A] bg-[#006156]">
              Buy Now
            </button>
          </div>
          </div>
