...
const FifthPage = () => {
  return (
    ...
    <div className="flex flex-col items-center border border-black md:h-screen "style={{ backgroundImage: `url(${bg})` }}>
...
<div className='grid mt-9 px-5  md:px-[4rem] gap-11 items-center    h-[20rem] grid-cols-1 md:grid-cols-2' >
