      ...
      >
        <div className="mt-[4rem] px-5  text-white text-center  text-2xl">
          <h1 className="text-[2rem] ">
            Let’s Discover DriveMond’s{" "}
            <span className="font-bold "> Business Potential</span>
            <h2 className="mt-8 text-[20px] font-normal text-center ">
              With DriveMond’s two dynamic modules, you can do various
              businesses and unlock the utmost potential.
            </h2>
          </h1>
        </div>
        <div className="grid mt-[3rem] px-[10%]  md:px-[4rem] gap-11  items-center    md:h-[20rem] grid-cols-1 md:grid-cols-2">
          <div className="px-9 rounded-2xl flex flex-col justify-between items-center border lg:w-[27rem]  h-[20rem] py-7 md:w-[22rem] bg-[#E9FFFC] ">
            ...
            <h1 className="text-2xl text-[#00423A] font-bold">Ride Sharing</h1>
            <p className="text-[#00A08D] text-center ">
              Create zone-wise vehicles and connect drivers & start zone-wise
              ride sharing business with DriveMond. Customers can request a
              custom fare while drivers can bid for that request.
            </p>
          </div>
          <div className="px-9 rounded-2xl flex flex-col items-center justify-between py-5  lg:w-[27rem] h-[20rem] md:w-[22rem] bg-[#E9FFFC] ">
            ...
            <p className="text-[#00A08D] text-center ">
              Start parcel delivery business for customers. The registered
              drivers can join this module and you can ensure seamless parcel
              delivery service to all the customers.
            </p>
          </div>
        </div>
      </div>
