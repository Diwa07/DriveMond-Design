...
const SecondPage = () => {
  ...
  return (
    <>
      <div className="text-white  lg:h-[100vh] ">
        <div
          className=" lg:h-[60%]   border border-black "
          style={{
            ...
            <section className="  justify-center  py-7 mt-[2rem]   flex flex-col items-center">
              <p className="flex flex-col  text-center  py-2 px-[7%] md:px-[20%] justify-center">
                ...
                <h2 className="text-xl ">
                  DriveMond ensures a total ride sharing experience for all its
                  users, such as drivers, customers, and the admin.
                </h2>
              </p>
                  ...
                  posts.map((item, id) => {
                    return (
                      <div
                        ...
                        className="h-[17rem]  py-5 flex flex-col border lg:border-white  border-[#003F37]   items-center px-3 justify-between p-2  w-[100%] sm:w-[17rem] md:w-[15rem]  hover:text-[white] hover:bg-[#00A08D] cursor-pointer rounded-2xl text-[#00423A]   bg-[#FFFFFF]"
                      >
                        <p className="polygon bg-[#006156d0]   h-[3rem] w-[3rem] items-center flex justify-center text-xl text-white">
                          {item.icon}
                        </p>
                        <p className="text-xl font-bold ">{item.title}</p>
                        <p className=" text-[1rem] flex text-center  ">
                          {item.message}{" "}
                        </p>
