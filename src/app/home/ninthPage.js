  ...
  return (
    <div className='flex flex-col px-[10%] items-center h-screen'>
      ...
      <div className='grid  text-[#FFFFFF] text-xl font-bold h-auto grid-cols-1 px-3 py-10 gap-11 md:gap-5 md:grid-cols-3'> 
        <figure className='flex h-auto border hover:border-[#00A08D] px-1 flex-col justify-center md:h-[23rem] w-[15rem] md:w-[17rem] rounded-2xl'>
          <div className='flex'>
        ...
        <figure className='flex h-auto flex-col border px-1 hover:border-[#00A08D] justify-center md:h-[23rem] w-[15rem] md:w-[17rem] rounded-2xl'>
