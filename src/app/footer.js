...
const Footer = () => {
  return (
    <div className="md:h-screen flex flex-col mt-4 justify-center  text-[white] bg-[#00211D]">
      <div className="h-full bg-[#00211D]  text-center px-[7%] py-[4%] grid-cols-1  gap-[2%] grid md:grid-cols-3 ">
        <div className="" >
          ...
          DriveMond is a complete ride sharing and
          parcel delivery solution that comes with full source code. With
          DriveMond, you’ll get an admin panel and a user app at once. You can
          launch your ride sharing business today with DriveMond!
          </p>
        </div>
        <div>
    ...
    30 N Gould ST STE R, Sheridan, WY 82801
          ...
          <li className="flex gap-4" >  <MdMarkEmailRead className="text-4xl" />       support@6amtech.com Support Ticket</li>
<li>
      ...
      <div className="h-[3rem] mt-5  flex justify-center items-center rounded-tl-[30rem] rounded-tr-[30rem]  bg-black text-white">
        <h1>
        © 2024 6amTech. All rights reserved
        </h1>
      </div>
    </div>
  );
